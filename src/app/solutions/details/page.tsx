...
function SolutionsDetailsContent() {
  ...
  useEffect(() => {
    if (moduleParam && solutionsDb[moduleParam]) {
      setActiveKey(moduleParam);
    }
  }, [moduleParam]);

  const solutions = Object.values(solutionsDb);
  const solution = solutionsDb[activeKey] || solutions[0];
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0d0d0e] transition-colors duration-300 flex flex-col font-sans">
      ...
      <main className="flex-grow">
        ...
        {/* Solution Details Page Main Banner (Inline Typography Switcher) */}
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-[900] tracking-tight text-zinc-900 dark:text-white leading-[1.25] pt-3 relative">
              ...
              <span className="relative inline-block text-left align-middle">
                ...
                {isDropdownOpen && (
                  <div className="absolute left-1/2 -translate-x-1/2 mt-3 w-80 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 rounded-2xl shadow-2xl p-2 z-50 flex flex-col gap-1 origin-top animate-fade-in">
        ...
        {/* Dynamic Detail Viewer (Hero + Why Choose + Features Grid) */}
          ...
          <section className="mx-auto max-w-7xl px-6 md:px-8 py-10 md:py-16">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-7 flex flex-col justify-center space-y-6 md:space-y-8 text-left">
                ...
                {/* Subtitle */}
                <h3 className="text-lg md:text-xl font-bold text-zinc-700 dark:text-zinc-300">
                  {solution.subtitle}
                </h3>
